...
icon='delete' style={{ marginBottom: '5px' }}
content='刪除' />
        <Modal open={this.state.show} closeOnDimmerClick={false}
basic>
          ...
          <Modal.Actions>
            <Button color='grey' loading={this.state.loading}
onClick={this.close} content='取消' />
            <Button color='red' loading={this.state.loading}
onClick={this.delete} content='確認' />
          </Modal.Actions>
        </Modal>
      </React.Fragment>
    );
